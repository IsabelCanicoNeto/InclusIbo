...
class DashSense(object):
    ...
    def subscribe(self):
        ...
        loop.run_until_complete(self.connection.start_notify(CHARACTERISTICS["dash_sensor"], self._dash_sensor_decode))
    ...
    def unsubscribe(self):
        ...
        """
        loop = asyncio.get_event_loop()
        loop.run_until_complete(self.connection.stop_notify(CHARACTERISTICS["dash_sensor"]))
